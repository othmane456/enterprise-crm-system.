<div align="center">
  ...
  <h2 align="center">Enterprise CRM & Sales Dashboard</h2>

  <div align="center">
     Developed by <b>Othmane El Foual</b> as a professional demonstration of modern web architecture.
  </div>
</div>
...
This is a high-performance, React-based CRM dashboard designed for enterprise-level sales management. It features a robust authentication system, interactive analytics charts, and a real-time Kanban board.

The project demonstrates my ability to handle complex state management, GraphQL integrations, and professional UI components using **Ant Design** and **Refine**.

## <a name="tech-stack">⚙️ Tech Stack</a>

- **Frontend:** React.js, TypeScript
- **State & Data:** GraphQL, Codegen, Refine
- **UI Framework:** Ant Design
- **Build Tool:** Vite

## <a name="features">🔋 Features</a>

👉 **Enterprise Authentication**: Secure login/signup with advanced session management.

👉 **Dynamic Analytics**: Interactive home page with real-time charts for business metrics and upcoming events.

👉 **Full CRUD Companies Management**: Comprehensive sales pipeline management including adding, editing, and searching company profiles with pagination.

👉 **Real-time Kanban Board**: Interactive task management system with live updates, markdown support, and multi-assignee functionality.

👉 **Mobile-First Responsive Design**: Optimized for a seamless experience across all devices and screen sizes.
...
git clone [https://github.com/YOUR_GITHUB_USERNAME/refine_dashboard.git](https://github.com/YOUR_GITHUB_USERNAME/refine_dashboard.git)
cd refine_dashboard
